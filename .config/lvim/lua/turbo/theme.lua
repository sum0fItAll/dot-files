...
M.toggle_theme = function()
  ...
  local colorset = require("turbo.theme").colors.tokyonight_colors
  if theme == "tokyonight" then
    lvim.colorscheme = "catppuccin-mocha"
    colorset = require("turbo.theme").colors.catppuccin_colors
  else
  ...
  require("turbo.theme").telescope_theme(colorset)
end
